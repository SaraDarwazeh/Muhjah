...
import "./Navbar.css";
import logo from "../../assets/logo.jpg";      // شعار التطبيق
    ...
    <nav className="navbar navbar-expand-lg bg-white shadow-sm fixed-top">
      <div className="container-fluid">
        ...
        <Link className="navbar-brand fw-bold d-flex align-items-center" to="/main">
          ...
          <span className="brand-text">Baby Bloom</span>
        </Link>

        {/* روابط التصفّح */}
        <div className="collapse navbar-collapse justify-content-center">
          <ul className="navbar-nav">
            {["Overview", "Appointments", "Patients", "Schedule", "Reports", "Messages"].map(
              (item, index) => (
        ...
        <div className="user-profile" onClick={toggleDropdown}>
          <img
            src={doctorImg} // ✅ استخدام صورة الدكتور من assets
            alt="User"
            className="profile-img"
          />
          <div className="user-info">
            <span className="d-block fw-semibold">Dr. Name</span>
